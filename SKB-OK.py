...
def menu():
	...
	print(" [*] ---------------------------------------") 
	print(" [+] Author : https://facebook.com/https://www.facebook.com/Termux.User.Tera.Next.Daddy") 
	print(" [+] GitHub : https://github.com/ALAMIN-XD89")
	print(" [*] ---------------------------------------") 
	print(" [1]. crack Id random new")
	print(" [2]. crack Id random old")
	print(" [3]. crack Id nama email")
	print(" [4]. File Clone crack")
	ask = input("\n [?] pilih : ")
	if ask in["1"]:
		random_new()
	elif ask in["2"]:
		...
		if hasil in["1"]:
			...
			print(" [#] ----------------------------------------------")
			print(f" [+] total SKB TEAM crack ok : {len(hasilcp)}")
			print(f" [#] ----------------------------------------------{K}")
...
def nama_email():
	nama = input(" [+] masukan nama (cth: Alamin-xd89) : ")
	email = input(" [+] masukan email (cth: @gmail.com) : ")
	limit = int(input(" [+] masukan total limit : 500000"))
	for z in range(limit):
...
def atursandi():
	...
	print("\n [+] SKB crack ok tersimpan di -> ok.txt")
	print(" [+] SKB crack cp tersimpan di -> cp.txt\n")
